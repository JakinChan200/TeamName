...
def evaluation(board): #Evaluate the state of the board (data)
    ...
    for i in range(4):
        for k in range(4):
            ...
            differenceBetweenAdjacentTilesPenalty = 0;
            if board[i][k] != "":
            ...
            #points = adjacentTilesPenaltyWeight * differenceBetweenAdjacentTilesPenalty
    return points
